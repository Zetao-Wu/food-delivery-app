        ...
        {orders.map((order, index) => {
          return (
            <div key={index} className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] items-start gap-4 sm:gap-6 p-4 border border-orange-500 my-4 text-sm sm:text-base text-[#505050]">
              ...
              <select onChange={(event) => statusHandler(event, order._id)} value={order.status} className="bg-[#ffe8e4] border border-orange-500 w-full sm:w-[10vw] p-2 sm:p-3 outline-none truncate">
